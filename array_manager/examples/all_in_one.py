...
# dense = DenseMatrix(block, duplicate_indices=True)
# coo = COOMatrix(block)
coo = COOMatrix(block, duplicate_indices=True)
# csr = CSRMatrix(block)
csr = CSRMatrix(block, duplicate_indices=True)
# csc = CSCMatrix(block)
csc = CSCMatrix(block, duplicate_indices=True)
